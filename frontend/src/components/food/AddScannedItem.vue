    ...
    <div class="bg-white rounded-lg shadow-xl max-w-3xl w-full p-6 max-h-[90vh] overflow-y-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-4">
          ...
          <!-- Macros -->
          <div v-if="preview && preview.macros && preview.macros.length > 0" class="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <!-- Nutrients -->
          <div v-if="preview && preview.nutrients && preview.nutrients.length > 0" class="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <!-- Nutrient Levels -->
          <div v-if="preview && preview.nutrientLevels && Object.keys(preview.nutrientLevels).length > 0" class="bg-white border border-gray-200 rounded-lg p-4">
        ...
        <div class="space-y-4">
          ...
          <!-- Preview Section -->
          <ScannedItemPreview :preview="preview" :percentage="percentage" />
