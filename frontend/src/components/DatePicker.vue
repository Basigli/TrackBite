<template>
  <div class="date-picker-container relative">
    <button
      ...
      class="date-picker-button flex items-center gap-1 px-3 py-1 bg-white/20 hover:bg-white/30 rounded-lg transition-all duration-200 backdrop-blur-sm border border-white/30"
    >
